defmodule PointsAppWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PointsAppWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PointsAppWeb.Gettext, "errors", msg, opts)
    end
  end
