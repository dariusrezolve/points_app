defmodule PointsApp.Storage do
  ...
  def update_all_users do
    ...
    # Repo,
    # "UPDATE users SET points = floor(random() * 101)",
    # []
    # )
    ...
    # create this once for all the batches
    #   Ecto.Adapters.SQL.query!(
    # Repo,
    # "create table rn as (select id, row_number() over (order_by id) as rn from users)",
    # []
    # )
    ...
    # Ecto.Adapters.SQL.query!(
    # Repo,
    # "update users set points = floor(random() * 101) from rn where users.id = rn.id and rn.rn = >",
    # []
    # )
    # end
    #   end)
