...
config :points_app, PointsApp.Repo,
  ...
  database: System.get_env("PGDATABASE", "points_app_dev"),
...
config :points_app, PointsAppWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "l1d/AG3aodVbff+gfLekI0tBT41zuR778l6kBheozQRKBVL6XOuVRs92Fowh9Sys",
  watchers: [
...
config :points_app, PointsAppWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/points_app_web/(controllers|live|components)/.*(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :points_app, dev_routes: true
